...
function runBaseTests() {
  px_vis_iron_list_1 = document.getElementById('px_vis_iron_list_1');

  suite('Base Automation Tests for px-vis-iron-list', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-iron-list fixture is created', function() {
      assert.isTrue(document.getElementById('px_vis_iron_list_1') !== null);
    });
